...
#
# # title
# app_desc_label = tk.Label(master=window, text="Unit Converter", font=("Roboto", 18, "italic"))
# app_desc_label.pack()
#
#
# def set_from(_):
#     global choice_to
#     if choice_from.get() == "Mile":
...
# table
table: ttk.Treeview = ttk.Treeview(window, columns=("Name", "Email", "Phone"), show="headings")
table.heading("Name", text="name", anchor=tk.CENTER)
table.heading("Email", text="email", anchor=tk.CENTER)
table.heading("Phone", text="Ph. No.", anchor=tk.CENTER)
table.pack(fill="both", expand=True)

# insert values
table.insert("", index=tk.END, values=("George", "holo@gmail.com", 7887384332))
table.bind("<<TreeviewSelect>>", lambda x: print(table.selection()))
